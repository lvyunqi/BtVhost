...
import com.chuqiyun.chuqicloudbtvhost.entity.LicenseVerifyParam;
import com.chuqiyun.chuqicloudbtvhost.key.CustomKeyStoreParam;
...
public class LicenseVerify {
    ...
    public synchronized LicenseContent install(LicenseVerifyParam param){
        ...
        try{
            ...
            logger.info(MessageFormat.format("校验成功，授权有效期：{0} - {1}",format.format(result.getNotBefore()),format.format(result.getNotAfter())));
        }catch (Exception e){
            logger.error("校验失败！",e);
        }
